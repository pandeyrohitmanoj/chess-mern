  ...
  return (
    <div className='spinner' style={{ display: loadBookCarMessage ? "" : "none"}} > 
      <div className='spinner-text'>
        ...
        Instead of it The car will be hidden for the time period in which you selected the car booking if you want to see the car again, adjust the start date in above screen before the time period you booked. 
        Also that car will be added to your history, its visible in you history page of available in sidebar.
